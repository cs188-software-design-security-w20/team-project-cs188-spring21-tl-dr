...
describe('User Model',function(){
    ...
    describe('Test CRUDS', function(){
        ...
        it('should update data', function(done){
            var cb = sinon.spy();
            var myuser = User.updateMany({name: 'femi'},{name: 'Olaoluwa'});
        ...
        it('should delete data', function(done){
            ...
            ouruser.then(function(res){
                res.should.be.an.object; /* jslint ignore:line */
                return User.deleteOne({name: 'bolu'});
            }).then(function(res){
                cb2();
        ...
        it('should add updatedAt', function(done){
            ...
            myuser.then(function(res){
                id2 = res._id;
                return User.updateMany({_id: id},{name: 'This is the titan'});
            })
            .then(function(res){
        ...
        it('should tag database entries properly', async function(){
            var myuser = await User.create({name: 'femi',someOtherStringData: 'stuff'});
            
            return q.Promise(function(resolve, reject) {
            setTimeout(function(){
                User.findById(myuser._id)
                .then(function(res){
                    console.log(res);
        ...
        it('should count returned records', function(done){
            var myuser = User.estimatedDocumentCount({name: 'This is the titan'});
