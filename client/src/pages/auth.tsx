      ...
      <div>
        {!isLogin ? (
          <div>
            ...
            >
              <Link to="/" style={{ textDecoration: "none", color: "#C4C4C4" }}>
                TL;DR Websites
              </Link>
            </div>
            <div
            ...
            >
              <div
                style={{
                  boxShadow: "5px 5px 5px 5px #C4C4C4",
                  width: 500,
                  padding: "30px 50px 30px 50px",
                  borderRadius: 25,
                }}
              >
                <div style={{ fontFamily: "Rhodium Libre", fontSize: 36 }}>
                  Sign Up!
                </div>
                <input
                  type="text"
                ...
                >
                  ...
                  >
                    <Link to="/auth?signup=false" style={{ color: "black" }}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Link to="/auth?signup=true" style={{ color: "black" }}>
